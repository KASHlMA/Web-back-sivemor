...
class MerCompatibilityService(
    ...
    private fun populateEvaluacion(inspection: Inspection, evaluacion: Evaluacion) {
        ...
        evaluacion.llantasTuercasDelanteraIzquierdaFaltantes = parseIntAnswer(inspection, "llantas_tuercas_delantera_izquierda_faltantes")
        evaluacion.llantasTuercasDelanteraIzquierdaRotas = parseIntAnswer(inspection, "llantas_tuercas_delantera_izquierda_rotas")
        evaluacion.llantasTuercasDelanteraDerecha = mapAnswerEnum(answersByCode["llantas_tuercas_delantera_derecha"])
        evaluacion.llantasTuercasDelanteraDerechaFaltantes = parseIntAnswer(inspection, "llantas_tuercas_delantera_derecha_faltantes")
        evaluacion.llantasTuercasDelanteraDerechaRotas = parseIntAnswer(inspection, "llantas_tuercas_delantera_derecha_rotas")
        evaluacion.llantasTuercasTraseraIzquierda = mapAnswerEnum(answersByCode["llantas_tuercas_trasera_izquierda"])
        evaluacion.llantasTuercasTraseraIzquierdaFaltantes = parseIntAnswer(inspection, "llantas_tuercas_trasera_izquierda_faltantes")
        evaluacion.llantasTuercasTraseraIzquierdaRotas = parseIntAnswer(inspection, "llantas_tuercas_trasera_izquierda_rotas")
        evaluacion.llantasTuercasTraseraDerecha = mapAnswerEnum(answersByCode["llantas_tuercas_trasera_derecha"])
        evaluacion.llantasTuercasTraseraDerechaFaltantes = parseIntAnswer(inspection, "llantas_tuercas_trasera_derecha_faltantes")
        evaluacion.llantasTuercasTraseraDerechaRotas = parseIntAnswer(inspection, "llantas_tuercas_trasera_derecha_rotas")
